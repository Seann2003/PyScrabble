...
const python_quiz_questions = [
    {
        "question_title": "What keyword is used to define a class in Python?",
        "options": ["class", "def", "function"],
        "correct_answer": "class",
        "difficulty": 1
    },
    // {
    //     "question_title": "Which method is automatically called when an object is created?",
    //     "options": ["__init__", "__main__", "__str__"],
    //     "correct_answer": "__init__",
    //     "difficulty": 1
    // },
    // {
    //     "question_title": "What is the first parameter in a method definition within a class?",
    //     "options": ["self", "this", "class"],
    //     "correct_answer": "self",
    //     "difficulty": 1
    // },
    {
        "question_title": "What is encapsulation in object-oriented programming?",
        "options": [
    ...
    {
        "question_title": "Which of the following is used to create an instance of a class?",
        "options": [
            "Constructor",
            "Method",
            "Attribute"
    ...
    {
        "question_title": "What does the 'super()' function do in a class?",
        "options": [
    ...
    {
        "question_title": "What is method overriding in Python?",
        "options": [
    ...
    {
        "question_title": "Which of the following is true about multiple inheritance in Python?",
        "options": [
    ...
    {
        "question_title": "What is a metaclass in Python?",
        "options": [
    ...
    {
        "question_title": "What is the output of the following code?\n\nclass A:\n    def __init__(self):\n        print(1)\n\nclass B(A):\n    def __init__(self):\n        print(2)\n        super().__init__()\n\nclass C(B):\n    def __init__(self):\n        print(3)\n        super().__init__()\n\nC()",
        "options": [
            "3 2 1",
            "1 2 3",
            "3 1 2"
    ...
    {
        "question_title": "Which of the following is true about the __slots__ attribute in Python classes?",
        "options": [
    ...
    {
        "question_title": "What is the purpose of the __new__ method in Python classes?",
        "options": [
            ...
            <section className="flex justify-center gap-x-4 items-center w-full">
                ...
                .map((question, index) => (
                    <div key={index} className="flex justify-center items-center flex-col">
                        ...
                        <div className="flex justify-center text-center items-start pt-32 text-white rounded-lg max-w-[900px] h-[300px] text-4xl">{question.question_title}</div>
